        ...
        <div className="max-w-7xl mx-auto sm:px-16 px-4">
          ...
          >
            <p className="text-base font-normal sm:px-2 px-10 text-muted-foreground text-center">
              Tenants and station organizations running operations on OpsTrack
            </p>
            <div className="py-4">
              <Marquee pauseOnHover className="[--duration:20s] p-0">
                {brandList.map((brand) => (
                  <div
                    ...
                    className="flex h-12 w-40 shrink-0 items-center justify-center mr-6 lg:mr-16"
                  >
                    {brand.lightimg ? (
                      <>
                        <img
                          src={brand.image}
                          alt={brand.name}
                          className="max-h-10 max-w-36 w-auto object-contain dark:hidden"
                        />
                        <img
                          src={brand.lightimg}
                          alt={brand.name}
                          className="hidden dark:block max-h-10 max-w-36 w-auto object-contain"
                        />
                      </>
                    ) : (
                      <img

...
/**
 * Web API keys that an app-only user may satisfy with mobile.tenant.* grants.
 * Station/price reads are shared by the mobile home, prices tab, and ledger refresh.
 */
export const MOBILE_EQUIVALENT_PERMISSIONS: Partial<Record<PermissionKey, readonly PermissionKey[]>> = {
  [PERMISSIONS.TENANT_STATIONS_READ.key]: ALL_MOBILE_PERMISSION_KEYS,
  [PERMISSIONS.TENANT_PRICES_READ.key]: ALL_MOBILE_PERMISSION_KEYS,
  [PERMISSIONS.TENANT_BANK_ACCOUNTS_READ.key]: ALL_MOBILE_PERMISSION_KEYS,
  ...
  [PERMISSIONS.TENANT_DIPPINGS_WRITE.key]: [PERMISSIONS.MOBILE_TENANT_DIPPINGS_WRITE.key],
  ...
  [PERMISSIONS.TENANT_WAYBILLS_WRITE.key]: [PERMISSIONS.MOBILE_TENANT_WAYBILLS_WRITE.key],
  ...
  [PERMISSIONS.TENANT_EXPENSES_WRITE.key]: [PERMISSIONS.MOBILE_TENANT_EXPENSES_WRITE.key],

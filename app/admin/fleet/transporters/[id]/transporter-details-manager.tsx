        ...
        <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <Button variant="outline" size="icon" asChild className="h-10 w-10 shrink-0">
              <Link href="/admin/fleet/transporters">
          ...
          <CardAction className="flex flex-wrap items-center gap-2">
            ...
            <Button asChild className="gap-2">
              <Link href={`/admin/fleet/drivers/new`}>
                    ...
                    trucks.map((truck: any) => (
                      <tr key={truck.id} className="hover:bg-muted/10">
                        <td className="px-6 py-4">
                          <Link href={`/admin/fleet/trucks/${truck.id}`} className="font-medium text-primary hover:underline">
                            {truck.name}
                          </Link>
                        </td>
                  ...
                  {drivers.length === 0 ? (
                    ...
                    drivers.map((driver: any) => (
                      <tr key={driver.id} className="hover:bg-muted/10">
                        <td className="px-6 py-4">
                          <Link href={`/admin/fleet/drivers/${driver.id}`} className="font-medium text-primary hover:underline">

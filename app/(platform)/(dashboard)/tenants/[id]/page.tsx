    ...
    <div>
      ...
      <Tabs defaultValue="basic" className="w-full">
        ...
        <TabsContent value="basic" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase text-stone-500">Metadata Details</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase text-stone-500">Modules</CardTitle>
            </CardHeader>
            <CardContent className="divide-y divide-stone-100 dark:divide-stone-800">
              <div className="flex items-center justify-between py-4 first:pt-0 last:pb-0">
                <div>
                  <p className="text-sm font-medium">Station Management</p>
                  <p className="text-xs text-stone-500">Enable fuel stations, tanks, pumps, and shift management features.</p>
                </div>
                <TenantModuleToggle 
                  tenantId={tenant.id} 
                  module="STATION" 
                  enabled={tenant.activeModules.includes("STATION")} 
                />
              </div>
              <div className="flex items-center justify-between py-4 first:pt-0 last:pb-0">
                <div>
        ...
        <TabsContent value="users">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase text-stone-500">Tenant Users</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="activity">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase text-stone-500">Tenant Activity</CardTitle>
            </CardHeader>
            <CardContent>

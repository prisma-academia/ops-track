        ...
        <Card className="border-border/40 shadow-xs">
          <CardContent className="p-6 flex flex-col justify-center items-start h-full">
             <div className="flex items-center gap-2 mb-4">
               ...
               <p className="text-sm font-medium text-muted-foreground tracking-wider uppercase">Transport Revenue</p>
             </div>
        ...
        <Card className="border-border/40 shadow-xs">
          <CardContent className="p-6 flex flex-col justify-center items-start h-full">
             <div className="flex items-center gap-2 mb-4">
               ...
               <p className="text-sm font-medium text-muted-foreground tracking-wider uppercase">Fleet Expenses</p>
             </div>

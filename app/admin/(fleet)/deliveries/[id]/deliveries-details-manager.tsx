      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 space-y-6">
          ...
          <TabsContent value="overview" className="mt-6 space-y-6">
            ...
            {(() => {
              ...
              // Loading fee
              const loadingFeePerLitre = Number(delivery.transport?.order?.loadingCostPerLitre || 0);
        ...
        <div className="w-full lg:w-72 shrink-0 space-y-6">
          <div className="p-5 border rounded-2xl bg-card space-y-4">
            ...
            <Button size="lg" className="w-full justify-start" variant="outline" onClick={() => window.open(`/admin/deliveries/${delivery.id}/print`, '_blank')}>

        ...
        <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" asChild>
              <Link href={`/admin/trucks/${truck.id}/edit`}>Edit Truck</Link>
            </Button>
          </div>
        </CardHeader>
      </Card>
          ...
          <CardContent className="flex-1 flex flex-col justify-center items-center text-center p-6">
            ...
            {truck.transporter && (
              <Button variant="outline" asChild className="h-8 text-xs">
                <Link href={`/admin/transporters/${truck.transporter.id}`}>
                    ...
                    transports.map((t: any) => (
                      <tr key={t.id} className="hover:bg-muted/10">
                        ...
                        <td className="px-6 py-4 text-muted-foreground text-xs">
                          {t.driver ? (
                            <Link href={`/admin/drivers/${t.driver.id}`} className="hover:underline text-primary">

...
export default function FooterSection({ slug = "App", name = "App", logoUrl }: { slug?: string, name?: string, logoUrl?: string | null }) {
    return (
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    {logoUrl ? (
                        <img src={logoUrl} alt={name || slug || "Logo"} className="h-8 w-auto object-contain rounded-md" />
                    ) : (
                ...
                <span className="text-muted-foreground block text-center text-sm"> &copy; {new Date().getFullYear()} {name}, All rights reserved</span>
            </div>
        </footer>
    )
}
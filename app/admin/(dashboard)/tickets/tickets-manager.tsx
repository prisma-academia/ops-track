...
import { Ticket, CheckCircle2, Maximize2, Minimize2, Printer, LayoutGrid, TableProperties, Filter, AlertCircle, Calendar } from "lucide-react";
...
export function TicketsManager({
  ...
  const stats = useMemo(() => {
    ...
    filteredTickets.forEach((t) => {
      ...
      if (t.category === "INVENTORY_VARIANCE") totalVariances++;
    });

    return { total: filteredTickets.length, openCount, resolvedCount, totalVariances };
  }, [filteredTickets]);
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: stats.totalVariances.toString(),
      fullValue: null,
      icon: Filter,
                    ...
                    <div className="space-y-1 w-full">
                      ...
                      <Select value={draftCategory} onValueChange={setDraftCategory}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="INVENTORY_VARIANCE">Inventory Variance</SelectItem>

...
export async function GET(
  ...
  try {
    ...
    const actor = await requireTenantActor(PERMISSIONS.TENANT_FLEET_DRIVERS_READ.key, "FLEET");
...
export async function PATCH(
  ...
  try {
    ...
    const { id } = await params;
    const actor = await requireTenantActor(PERMISSIONS.TENANT_FLEET_DRIVERS_WRITE.key, "FLEET");

...
export function OrganizationForm({ users }: { users: { id: string; firstName: string | null; lastName: string | null; email: string }[] }) {
  ...
  async function onSubmit(data: FormValues) {
    ...
    setErrorMsg(null);
    try {
      const res = await apiPost<{ organization: any }>("/api/tenant/organizations", {
        ...data,
              ...
              <div className="pt-4 border-t space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="companyEmail" type="email" placeholder="contact@acme.com" {...register("companyEmail")} />
                  </div>
                  <div className="space-y-2">
